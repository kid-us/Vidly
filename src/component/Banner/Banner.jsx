...
const Banner = ({ fetchUrl }) => {
    ...
    return (
        <>
            {/* Large Device Banner */}
            <header className='banner-container d-none d-md-block'
                style={{
            ...
            {/* Small device Banner */}
            <header className='banner-container d-block d-md-none'
                style={{
                    backgroundSize: "cover",
                    backgroundImage: `linear-gradient(to bottom, rgba(1, 1, 1, 0.20), rgba(0, 0, 0, 0.99)), url("https://image.tmdb.org/t/p/original/${movie?.poster_path || movie?.backdrop_path}")`,
                    backgroundPosition: "center top",
                    paddingTop: "50px"
                }}
            >
